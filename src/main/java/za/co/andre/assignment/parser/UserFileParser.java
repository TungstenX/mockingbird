...
/**
 * The parser for the User file. These are all static methods as there is no state to keep.
 *
...
public class UserFileParser {
    ...
    public static Map<String, User> Read(String fileName) throws IOException {
